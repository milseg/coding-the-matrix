...
representation_dict = {x:[(x//base**2), (x//base)%base, x%base] for x in range(min(base**3,10000))}
...
def all_3_digit_numbers(base, digits): return { x for x in range(base**digits) }
